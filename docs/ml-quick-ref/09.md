...
深度学习之父 Geoffrey Hinton 通过引入一种新的网络，在深度学习领域引起了巨大的轰动。这个网络被称为**胶囊网络** ( **胶囊网**)。还提出了训练该网络的算法，称为**胶囊间动态路由****。2011 年，Hinton 在一篇名为**转变自动编码器**的论文中首次谈到了这一点。2017 年 11 月，Hinton 和他的团队发表了关于胶囊网络的完整论文。**
