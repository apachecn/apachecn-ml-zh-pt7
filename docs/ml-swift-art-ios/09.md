...
因此，在本章的第二部分，我们将展示深度学习移动应用的完整开发周期。我们将拍摄标记有情绪的人脸照片，在 GPU 工作站上训练 CNN，然后使用 Keras、Vision 和 Core ML 框架将其集成到 iOS 应用程序中。
...
*   CNN 架构
*   如何将训练好的模型转换为核心 ML 格式，以便在 iOS 应用程序中使用
...
这里我们省略了应用程序的 UI 部分，完整代码请参考演示应用程序。



# 摘要

在这一章中，我们建立了一个深度学习 CNN，并使用 Keras 训练它识别照片上的面部表情。然后，我们使用 Core ML 将其移植到移动应用程序中。该模型可以实时工作。我们也已经熟悉了苹果的愿景框架。
