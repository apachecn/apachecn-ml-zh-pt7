...
这本书介绍了七个实际项目的实现，这些项目将教你如何利用 TensorFlow Lite 和 Core ML 来执行高效的机器学习。我们将了解 TensorFlow 及其扩展(如 TensorFlow Lite)的最新进展，以设计从复杂/大型数据集学习的智能应用程序。我们将通过使用深度神经网络架构构建应用程序来深入研究深度学习等进步，如**卷积神经网络**(**CNN**)、**递归神经网络** ( **RNNs** )、迁移学习等。
...
**粗体**:表示新术语、重要单词或您在屏幕上看到的单词。例如，菜单或对话框中的单词出现在文本中，如下所示。下面是一个例子:“让我们从初始屏幕中选择单视图应用程序，如下图所示。”
