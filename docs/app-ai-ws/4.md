<title>B16060_04_Final_SZ_ePub</title>
...
*   `cv`:指定分割数。
*   `scoring`:定义您想要使用的绩效指标。你可以在这里找到可能值的列表:[https://sci kit-learn . org/stable/modules/model _ evaluation . html # scoring-parameter](https://scikit-learn.org/stable/modules/model_evaluation.html#scoring-parameter)。
