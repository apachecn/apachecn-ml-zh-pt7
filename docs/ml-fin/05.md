<title>Chapter 5. Parsing Textual Data with Natural Language Processing</title> 
...
<title>Rule-based matching</title> 
...
<title>A text classification task</title> 
...
<title>Document similarity with word embeddings</title> 
...
<title>A quick tour of the Keras functional API</title> 
