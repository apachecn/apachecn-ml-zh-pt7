...
<title>Example – preprocessing data with Gota</title>  
...
<title>Loading the data into Gota</title>  
...
<title>Converting a column into a different type</title>  
...
<title>Sampling to obtain training/validation subsets</title>  
